const AboutCard = () => {
    return (
        <div className="mt-5 md:mt-0">
            <h3 className="md:text-4xl text-base md:font-semibold font-light m-0 md:mb-14 md:leading-[3rem]" style={{lineHeight: '3rem'}}>Product Designer and Developer, specialized in Front-End Devlopment, Back-End Development and Cross Platform Devlopment.</h3>
            <div className="grid md:grid-cols-3 grid-cols-1 md:gap-x-7 gap-y-4 mt-5">
                ...
                <a href='https://github.com/KingVics' target='_blank'>
                    <div>
